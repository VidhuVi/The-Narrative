...
* **Databases:** Firebase (Firestore) for real-time document syncing, **Upstash Serverless Vector DB** for fast semantic RAG retrieval.
* **APIs & Third-Party Tools:** Google Gemini Large Language Model APIs, LangGraph, Firebase Authentication, **Local PyTorch Sentence-Transformers** (`all-MiniLM-L6-v2`).
...
- Node.js (v18+)
- Python (3.11+) with at least 2GB of System RAM for Local Neural Nets
